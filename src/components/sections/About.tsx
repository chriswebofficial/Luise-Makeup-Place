      ...
      <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-lg leading-relaxed mb-6">
            At <span className="font-semibold">Lulu Makeup</span>, we believe
          ...
          <button className="bg-pink-500 hover:bg-pink-600 text-white px-6 py-3 rounded-full transition">
            Book an Appointment
          </button>
        </div>
...
/>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-lg leading-relaxed max-w-3xl mx-auto">
          Lulu Makeup was born from a passion for beauty and a deep appreciation
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-2xl shadow-md text-center">
              ...
              <p>
                From weddings to events, clients trust Lulu Makeup to deliver
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-lg mb-8">
          Book your session today and let Lulu bring your beauty vision to life.
        </p>
